...
trigsGT = pd.read_csv(
    "data/MOZ/outputs/Plots/triggers.aa.python.spi.dryspell.2022.{data_of_interest}.GT.csv"
)
trigsNRT = pd.read_csv(
    "data/MOZ/outputs/Plots/triggers.aa.python.spi.dryspell.2022.{data_of_interest}.NRT.csv"
)

trigs = pd.read_csv(
    "data/MOZ/outputs/Plots/triggers.aa.python.spi.dryspell.2022.{data_of_interest}.csv"
)
